const CustomarProfile = ({customer}) =>{
    return (
        <div className="w-full shadow-lg shadow-indigo-800 py-6 block">
        ...
        <div className="flex justify-between w-full px-4">
            <div className="w-1/4 flex justify-start items-center ">
                <img src={customer.image} alt="customer" className="w-16 h-16 ring-2 ring-indigo-950 shadow-lg shadow-indigo-900 rounded-full p-1"  />
            </div>
